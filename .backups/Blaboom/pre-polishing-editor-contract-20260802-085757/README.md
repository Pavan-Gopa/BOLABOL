...
- **`Blaboom.dmg`** on the [v1.0.1 release](https://github.com/Pavan-Gopa/Blaboom/releases/tag/v1.0.1).
...
1. Download **`Blaboom.dmg`** from the [v1.0.1 release](https://github.com/Pavan-Gopa/Blaboom/releases/tag/v1.0.1) (sign in if the repo is private).  
