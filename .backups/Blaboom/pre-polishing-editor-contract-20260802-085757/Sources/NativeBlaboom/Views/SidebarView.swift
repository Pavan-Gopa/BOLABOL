...
struct SidebarView: View {
    ...
    @State private var copiedNoteID: BlaboomNote.ID? = nil
    @State private var isCopyAllCopied = false
    @State private var selectedAudioNote: BlaboomNote? = nil
    ...
    private var archiveStatsText: some View {
        ...
        let labelText = String(format: generalSettingsStore.text(.archiveStatsLabel), stats.count, formattedSize)
        let tooltipText = String(format: generalSettingsStore.text(.archiveWarningTooltip), formattedSize, stats.count)
    ...
    private var selectionBinding: Binding<BlaboomNote.ID?> {
        Binding(
    ...
    private func copyNote(_ note: BlaboomNote) {
    ...
    private func retranscribeNote(_ note: BlaboomNote) {
