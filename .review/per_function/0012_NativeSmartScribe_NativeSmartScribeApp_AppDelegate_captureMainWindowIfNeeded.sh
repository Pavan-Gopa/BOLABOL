#!/bin/bash
# ============================================================
# Auto-generated review script for function #12
# Function: AppDelegate.captureMainWindowIfNeeded
# File:     Sources/NativeSmartScribe/App/NativeSmartScribeApp.swift:191
...
FUNC_NAME="captureMainWindowIfNeeded"
FUNC_LINE=191
...
echo "🔍 Reviewing: AppDelegate.captureMainWindowIfNeeded (Sources/NativeSmartScribe/App/NativeSmartScribeApp.swift:191)"
