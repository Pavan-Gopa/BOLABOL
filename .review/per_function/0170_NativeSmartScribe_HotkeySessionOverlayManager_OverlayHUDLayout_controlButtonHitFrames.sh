#!/bin/bash
# ============================================================
# Auto-generated review script for function #170
# Function: OverlayHUDLayout.controlButtonHitFrames
# File:     Sources/NativeSmartScribe/Services/HotkeySessionOverlayManager.swift:399
...
# Async:    False
# Throws:   False
# Returns:  (left: CGRect, right: CGRect)
# Body:     6 lines
# ============================================================
...
FUNC_NAME="controlButtonHitFrames"
FUNC_LINE=399
...
echo "🔍 Reviewing: OverlayHUDLayout.controlButtonHitFrames (Sources/NativeSmartScribe/Services/HotkeySessionOverlayManager.swift:399)"
