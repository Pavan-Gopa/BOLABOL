#!/bin/bash
# ============================================================
# Auto-generated review script for function #335
# Function: PromptTemplateStore.containsTranscriptionPlaceholder
# File:     Sources/NativeSmartScribe/Stores/PromptTemplateStore.swift:85
...
echo "🔍 Reviewing: PromptTemplateStore.containsTranscriptionPlaceholder (Sources/NativeSmartScribe/Stores/PromptTemplateStore.swift:85)"
