#!/bin/bash
# ============================================================
# Auto-generated review script for function #336
# Function: PromptTemplateStore.markdownContainsTranscriptionPlaceholder
# File:     Sources/NativeSmartScribe/Stores/PromptTemplateStore.swift:91
...
FILE_PATH="$PROJECT_ROOT/Sources/NativeSmartScribe/Stores/PromptTemplateStore.swift"
FUNC_NAME="markdownContainsTranscriptionPlaceholder"
FUNC_LINE=91
...
echo "🔍 Reviewing: PromptTemplateStore.markdownContainsTranscriptionPlaceholder (Sources/NativeSmartScribe/Stores/PromptTemplateStore.swift:91)"
