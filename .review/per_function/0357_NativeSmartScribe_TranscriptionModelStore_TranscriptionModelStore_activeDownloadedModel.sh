#!/bin/bash
# ============================================================
# Auto-generated review script for function #357
# Function: TranscriptionModelStore.activeDownloadedModel
# File:     Sources/NativeSmartScribe/Stores/TranscriptionModelStore.swift:272
...
# Async:    False
# Throws:   False
# Returns:  ActiveTranscriptionModel?
# Body:     11 lines
# ============================================================
...
FILE_PATH="$PROJECT_ROOT/Sources/NativeSmartScribe/Stores/TranscriptionModelStore.swift"
FUNC_NAME="activeDownloadedModel"
FUNC_LINE=272
...
echo "🔍 Reviewing: TranscriptionModelStore.activeDownloadedModel (Sources/NativeSmartScribe/Stores/TranscriptionModelStore.swift:272)"
