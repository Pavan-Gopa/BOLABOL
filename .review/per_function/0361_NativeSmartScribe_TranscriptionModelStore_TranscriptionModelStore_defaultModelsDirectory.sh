#!/bin/bash
# ============================================================
# Auto-generated review script for function #361
# Function: TranscriptionModelStore.defaultModelsDirectory
# File:     Sources/NativeSmartScribe/Stores/TranscriptionModelStore.swift:321
...
FUNC_NAME="defaultModelsDirectory"
FUNC_LINE=321
...
echo "🔍 Reviewing: TranscriptionModelStore.defaultModelsDirectory (Sources/NativeSmartScribe/Stores/TranscriptionModelStore.swift:321)"
