#!/bin/bash
# ============================================================
# Auto-generated review script for function #362
# Function: TranscriptionModelStore.defaultParakeetModelsDirectory
# File:     Sources/NativeSmartScribe/Stores/TranscriptionModelStore.swift:340
...
FUNC_NAME="defaultParakeetModelsDirectory"
FUNC_LINE=340
...
echo "🔍 Reviewing: TranscriptionModelStore.defaultParakeetModelsDirectory (Sources/NativeSmartScribe/Stores/TranscriptionModelStore.swift:340)"
