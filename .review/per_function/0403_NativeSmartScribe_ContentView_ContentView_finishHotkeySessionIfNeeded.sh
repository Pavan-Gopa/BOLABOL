#!/bin/bash
# ============================================================
# Auto-generated review script for function #403
# Function: ContentView.finishHotkeySessionIfNeeded
# File:     Sources/NativeSmartScribe/Views/ContentView.swift:987
...
FUNC_NAME="finishHotkeySessionIfNeeded"
FUNC_LINE=987
...
echo "🔍 Reviewing: ContentView.finishHotkeySessionIfNeeded (Sources/NativeSmartScribe/Views/ContentView.swift:987)"
