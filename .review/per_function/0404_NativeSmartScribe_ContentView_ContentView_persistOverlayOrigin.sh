#!/bin/bash
# ============================================================
# Auto-generated review script for function #404
# Function: ContentView.persistOverlayOrigin
# File:     Sources/NativeSmartScribe/Views/ContentView.swift:993
...
FUNC_NAME="persistOverlayOrigin"
FUNC_LINE=993
...
echo "🔍 Reviewing: ContentView.persistOverlayOrigin (Sources/NativeSmartScribe/Views/ContentView.swift:993)"
