#!/bin/bash
# ============================================================
# Auto-generated review script for function #501
# Function: HUDStylePreview.previewControlSquare
# File:     Sources/NativeSmartScribe/Views/Settings/GeneralSettingsView.swift:513
...
FILE_PATH="$PROJECT_ROOT/Sources/NativeSmartScribe/Views/Settings/GeneralSettingsView.swift"
FUNC_NAME="previewControlSquare"
FUNC_LINE=513
...
echo "🔍 Reviewing: HUDStylePreview.previewControlSquare (Sources/NativeSmartScribe/Views/Settings/GeneralSettingsView.swift:513)"
