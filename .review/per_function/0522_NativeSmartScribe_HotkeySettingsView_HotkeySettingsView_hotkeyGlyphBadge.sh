#!/bin/bash
# ============================================================
# Auto-generated review script for function #522
# Function: HotkeySettingsView.hotkeyGlyphBadge
# File:     Sources/NativeSmartScribe/Views/Settings/HotkeySettingsView.swift:277
...
FILE_PATH="$PROJECT_ROOT/Sources/NativeSmartScribe/Views/Settings/HotkeySettingsView.swift"
FUNC_NAME="hotkeyGlyphBadge"
FUNC_LINE=277
...
echo "🔍 Reviewing: HotkeySettingsView.hotkeyGlyphBadge (Sources/NativeSmartScribe/Views/Settings/HotkeySettingsView.swift:277)"
