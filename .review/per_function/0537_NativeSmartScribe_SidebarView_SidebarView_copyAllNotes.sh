#!/bin/bash
# ============================================================
# Auto-generated review script for function #537
# Function: SidebarView.copyAllNotes
# File:     Sources/NativeSmartScribe/Views/SidebarView.swift:98
...
FILE_PATH="$PROJECT_ROOT/Sources/NativeSmartScribe/Views/SidebarView.swift"
FUNC_NAME="copyAllNotes"
FUNC_LINE=98
...
echo "🔍 Reviewing: SidebarView.copyAllNotes (Sources/NativeSmartScribe/Views/SidebarView.swift:98)"
