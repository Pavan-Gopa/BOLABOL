#!/bin/bash
# ============================================================
# Auto-generated review script for function #594
# Function: GlossaryLanguageCatalog.defaultAutoTranslationLanguage
# File:     Sources/NativeSmartScribeCore/Models/GlossarySettings.swift:48
...
FILE_PATH="$PROJECT_ROOT/Sources/NativeSmartScribeCore/Models/GlossarySettings.swift"
FUNC_NAME="defaultAutoTranslationLanguage"
FUNC_LINE=48
...
echo "🔍 Reviewing: GlossaryLanguageCatalog.defaultAutoTranslationLanguage (Sources/NativeSmartScribeCore/Models/GlossarySettings.swift:48)"
