#!/bin/bash
# ============================================================
# Auto-generated review script for function #644
# Function: PromptTemplateSettings.init
# File:     Sources/NativeSmartScribeCore/Models/PromptTemplateSettings.swift:93
...
echo "🔍 Reviewing: PromptTemplateSettings.init (Sources/NativeSmartScribeCore/Models/PromptTemplateSettings.swift:93)"
