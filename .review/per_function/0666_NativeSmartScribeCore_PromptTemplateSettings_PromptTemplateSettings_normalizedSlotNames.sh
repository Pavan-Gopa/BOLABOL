#!/bin/bash
# ============================================================
# Auto-generated review script for function #666
# Function: PromptTemplateSettings.normalizedSlotNames
# File:     Sources/NativeSmartScribeCore/Models/PromptTemplateSettings.swift:453
...
FILE_PATH="$PROJECT_ROOT/Sources/NativeSmartScribeCore/Models/PromptTemplateSettings.swift"
FUNC_NAME="normalizedSlotNames"
FUNC_LINE=453
...
echo "🔍 Reviewing: PromptTemplateSettings.normalizedSlotNames (Sources/NativeSmartScribeCore/Models/PromptTemplateSettings.swift:453)"
