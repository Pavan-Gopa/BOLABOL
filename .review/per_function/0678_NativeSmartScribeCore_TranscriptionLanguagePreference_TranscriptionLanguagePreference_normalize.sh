#!/bin/bash
# ============================================================
# Auto-generated review script for function #678
# Function: TranscriptionLanguagePreference.normalize
# File:     Sources/NativeSmartScribeCore/Models/TranscriptionLanguagePreference.swift:18
...
FILE_PATH="$PROJECT_ROOT/Sources/NativeSmartScribeCore/Models/TranscriptionLanguagePreference.swift"
FUNC_NAME="normalize"
FUNC_LINE=18
...
echo "🔍 Reviewing: TranscriptionLanguagePreference.normalize (Sources/NativeSmartScribeCore/Models/TranscriptionLanguagePreference.swift:18)"
