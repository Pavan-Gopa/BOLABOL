#!/bin/bash
# ============================================================
# Auto-generated review script for function #721
# Function: CloudRawTranscriptionPrompt.instruction
# File:     Sources/NativeSmartScribeCore/Services/CloudRawTranscriptionPrompt.swift:8
...
FILE_PATH="$PROJECT_ROOT/Sources/NativeSmartScribeCore/Services/CloudRawTranscriptionPrompt.swift"
...
echo "🔍 Reviewing: CloudRawTranscriptionPrompt.instruction (Sources/NativeSmartScribeCore/Services/CloudRawTranscriptionPrompt.swift:8)"
