#!/bin/bash
# ============================================================
# Auto-generated review script for function #746
# Function: HotkeyOutputTextResolver.text
# File:     Sources/NativeSmartScribeCore/Services/HotkeyOutputTextResolver.swift:4
...
FILE_PATH="$PROJECT_ROOT/Sources/NativeSmartScribeCore/Services/HotkeyOutputTextResolver.swift"
FUNC_NAME="text"
FUNC_LINE=4
...
echo "🔍 Reviewing: HotkeyOutputTextResolver.text (Sources/NativeSmartScribeCore/Services/HotkeyOutputTextResolver.swift:4)"
