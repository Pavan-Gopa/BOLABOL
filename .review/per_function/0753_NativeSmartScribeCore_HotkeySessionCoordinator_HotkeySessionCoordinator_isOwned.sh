#!/bin/bash
# ============================================================
# Auto-generated review script for function #753
# Function: HotkeySessionCoordinator.isOwned
# File:     Sources/NativeSmartScribeCore/Services/HotkeySessionCoordinator.swift:82
...
echo "🔍 Reviewing: HotkeySessionCoordinator.isOwned (Sources/NativeSmartScribeCore/Services/HotkeySessionCoordinator.swift:82)"
