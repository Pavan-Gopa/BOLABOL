#!/bin/bash
# ============================================================
# Auto-generated review script for function #760
# Function: LocalMLXModelCompatibility.isReasoningModel
# File:     Sources/NativeSmartScribeCore/Services/LocalMLXModelCompatibility.swift:151
...
FILE_PATH="$PROJECT_ROOT/Sources/NativeSmartScribeCore/Services/LocalMLXModelCompatibility.swift"
FUNC_NAME="isReasoningModel"
FUNC_LINE=151
...
echo "🔍 Reviewing: LocalMLXModelCompatibility.isReasoningModel (Sources/NativeSmartScribeCore/Services/LocalMLXModelCompatibility.swift:151)"
