#!/bin/bash
# ============================================================
# Auto-generated review script for function #765
# Function: LocalModelPresence.isDirectory
# File:     Sources/NativeSmartScribeCore/Services/LocalModelPresence.swift:84
...
echo "🔍 Reviewing: LocalModelPresence.isDirectory (Sources/NativeSmartScribeCore/Services/LocalModelPresence.swift:84)"
