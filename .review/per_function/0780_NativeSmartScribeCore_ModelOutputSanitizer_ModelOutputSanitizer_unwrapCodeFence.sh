#!/bin/bash
# ============================================================
# Auto-generated review script for function #780
# Function: ModelOutputSanitizer.unwrapCodeFence
# File:     Sources/NativeSmartScribeCore/Services/ModelOutputSanitizer.swift:151
...
echo "🔍 Reviewing: ModelOutputSanitizer.unwrapCodeFence (Sources/NativeSmartScribeCore/Services/ModelOutputSanitizer.swift:151)"
