#!/bin/bash
# ============================================================
# Auto-generated review script for function #781
# Function: ModelOutputSanitizer.stripPlainTextThinking
# File:     Sources/NativeSmartScribeCore/Services/ModelOutputSanitizer.swift:180
...
FILE_PATH="$PROJECT_ROOT/Sources/NativeSmartScribeCore/Services/ModelOutputSanitizer.swift"
FUNC_NAME="stripPlainTextThinking"
FUNC_LINE=180
...
echo "🔍 Reviewing: ModelOutputSanitizer.stripPlainTextThinking (Sources/NativeSmartScribeCore/Services/ModelOutputSanitizer.swift:180)"
