#!/bin/bash
# ============================================================
# Auto-generated review script for function #783
# Function: ModelOutputSanitizer.extractLastParagraph
# File:     Sources/NativeSmartScribeCore/Services/ModelOutputSanitizer.swift:290
...
FUNC_NAME="extractLastParagraph"
FUNC_LINE=290
...
echo "🔍 Reviewing: ModelOutputSanitizer.extractLastParagraph (Sources/NativeSmartScribeCore/Services/ModelOutputSanitizer.swift:290)"
