#!/bin/bash
# ============================================================
# Auto-generated review script for function #796
# Function: PromptTemplate.init
# File:     Sources/NativeSmartScribeCore/Services/PromptTemplate.swift:7
...
echo "🔍 Reviewing: PromptTemplate.init (Sources/NativeSmartScribeCore/Services/PromptTemplate.swift:7)"
