#!/bin/bash
# ============================================================
# Auto-generated review script for function #798
# Function: PromptTemplate.renderForChat
# File:     Sources/NativeSmartScribeCore/Services/PromptTemplate.swift:28
...
echo "🔍 Reviewing: PromptTemplate.renderForChat (Sources/NativeSmartScribeCore/Services/PromptTemplate.swift:28)"
