#!/bin/bash
# ============================================================
# Auto-generated review script for function #800
# Function: PromptTemplate.defaultTemplate
# File:     Sources/NativeSmartScribeCore/Services/PromptTemplate.swift:80
...
FILE_PATH="$PROJECT_ROOT/Sources/NativeSmartScribeCore/Services/PromptTemplate.swift"
FUNC_NAME="defaultTemplate"
FUNC_LINE=80
...
echo "🔍 Reviewing: PromptTemplate.defaultTemplate (Sources/NativeSmartScribeCore/Services/PromptTemplate.swift:80)"
