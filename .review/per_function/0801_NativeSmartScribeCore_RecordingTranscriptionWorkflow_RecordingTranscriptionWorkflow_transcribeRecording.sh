#!/bin/bash
# ============================================================
# Auto-generated review script for function #801
# Function: RecordingTranscriptionWorkflow.transcribeRecording
# File:     Sources/NativeSmartScribeCore/Services/RecordingTranscriptionWorkflow.swift:18
...
FILE_PATH="$PROJECT_ROOT/Sources/NativeSmartScribeCore/Services/RecordingTranscriptionWorkflow.swift"
FUNC_NAME="transcribeRecording"
FUNC_LINE=18
...
echo "🔍 Reviewing: RecordingTranscriptionWorkflow.transcribeRecording (Sources/NativeSmartScribeCore/Services/RecordingTranscriptionWorkflow.swift:18)"
