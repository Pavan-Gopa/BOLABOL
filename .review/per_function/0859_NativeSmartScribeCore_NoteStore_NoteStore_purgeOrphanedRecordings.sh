#!/bin/bash
# ============================================================
# Auto-generated review script for function #859
# Function: NoteStore.purgeOrphanedRecordings
# File:     Sources/NativeSmartScribeCore/Stores/NoteStore.swift:88
...
FUNC_NAME="purgeOrphanedRecordings"
FUNC_LINE=88
...
echo "🔍 Reviewing: NoteStore.purgeOrphanedRecordings (Sources/NativeSmartScribeCore/Stores/NoteStore.swift:88)"
