#!/bin/bash
# ============================================================
# Auto-generated review script for function #875
# Function: NoteStore.purgeAllFiles
# File:     Sources/NativeSmartScribeCore/Stores/NoteStore.swift:289
...
echo "🔍 Reviewing: NoteStore.purgeAllFiles (Sources/NativeSmartScribeCore/Stores/NoteStore.swift:289)"
