#!/bin/bash
# ============================================================
# Auto-generated review script for function #884
# Function: SpeechCleanupNormalizer.collapseAdjacentDuplicates
# File:     Sources/NativeSmartScribeCore/Support/SpeechCleanupNormalizer.swift:60
...
FUNC_NAME="collapseAdjacentDuplicates"
FUNC_LINE=60
...
echo "🔍 Reviewing: SpeechCleanupNormalizer.collapseAdjacentDuplicates (Sources/NativeSmartScribeCore/Support/SpeechCleanupNormalizer.swift:60)"
