#!/bin/bash
# ============================================================
# Auto-generated review script for function #896
# Function: NativeSmartScribePolishWorker.modelPromptControlPrefix
# File:     Sources/NativeSmartScribePolishWorker/main.swift:287
# Module:   NativeSmartScribePolishWorker
# Kind:     function
# Access:   private
# Params:   1
# Async:    False
...
FILE_PATH="$PROJECT_ROOT/Sources/NativeSmartScribePolishWorker/main.swift"
FUNC_NAME="modelPromptControlPrefix"
FUNC_LINE=287
...
echo "🔍 Reviewing: NativeSmartScribePolishWorker.modelPromptControlPrefix (Sources/NativeSmartScribePolishWorker/main.swift:287)"
echo "   Module: NativeSmartScribePolishWorker | Kind: function | Access: private"
echo "   ------------------------------------------------------------"
