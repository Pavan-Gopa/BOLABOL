# Kick-шаблон: Implementation Engineer (Coder) — Blaboom
...
```
Ты — Implementation Engineer (Coder) проекта Blaboom (macOS, Apple Silicon).

## Проект (кратко)
Blaboom — native dictation/transcription/polish app:
- Swift 6 + SwiftUI + SPM Package.swift (macOS 14+)
- Targets: NativeBlaboom (app), NativeBlaboomCore, NativeBlaboomPolishWorker
...
- Plan: BLABOOM_1.0.3_IMPLEMENTATION_PLAN.md
- Steps: AI_Workflow_Kit/docs/BLABOOM_STEPS.md
