...
> Product plan: `BLABOOM_1.0.3_IMPLEMENTATION_PLAN.md`.
...
**Status:** Accepted  
**Decision:** `BLABOOM_1.0.3_IMPLEMENTATION_PLAN.md` is the only full plan. Spike log may live at `docs/canary/COREML_SPIKE.md` after B6. No parallel brief docs.  
...
**Status:** Accepted  
**Decision:** Git root is `AI Projects/`; checkpoint script stages only `Blaboom/` paths; tags `blaboom/pre-B*`, `blaboom/B*-done`.  
...
## ADR-012 — Canary alexwengg Core ML NO-GO for Blaboom 1.0.3

**Status:** Accepted (B6 spike 2026-08-03)  
**Decision:** Do **not** integrate `https://huggingface.co/alexwengg/canary-1b-v2-coreml` into Blaboom product (catalog, engine, HUD Canary mode, download UX).  
