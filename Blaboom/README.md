<p align="center">
  <img src="docs/branding/mark-white.png#gh-dark-mode-only" width="140" alt="Blaboom logo">
  <img src="docs/branding/mark-black.png#gh-light-mode-only" width="140" alt="Blaboom logo">
</p>

<h1 align="center">Blaboom</h1>
...
<p align="center">
  <a href="https://github.com/Pavan-Gopa/Blaboom/releases/latest"><img src="https://img.shields.io/github/v/release/Pavan-Gopa/Blaboom?style=flat-square&label=release&color=2ea44f" alt="Release"></a>
  <a href="https://github.com/Pavan-Gopa/Blaboom/releases"><img src="https://img.shields.io/github/downloads/Pavan-Gopa/Blaboom/total?style=flat-square&label=downloads&color=0e75b6" alt="Downloads"></a>
...
<p align="center">
  <a href="https://github.com/Pavan-Gopa/Blaboom/releases/latest">Download</a> ·
  <a href="#why-blaboom">Features</a> ·
...
- Plan: [`BLABOOM_1.0.3_IMPLEMENTATION_PLAN.md`](BLABOOM_1.0.3_IMPLEMENTATION_PLAN.md).
...
- **`Blaboom.dmg`** on the [v1.0.3 release](https://github.com/Pavan-Gopa/Blaboom/releases/tag/v1.0.3) (when published).
...
1. Download **`Blaboom.dmg`** from the [v1.0.3 release](https://github.com/Pavan-Gopa/Blaboom/releases/tag/v1.0.3) (sign in if the repo is private; when published).  
2. Open the DMG → drag **Blaboom** into **Applications**.  
...
```bash
git clone https://github.com/Pavan-Gopa/Blaboom.git
cd Blaboom   # this repository is the NativeAppleSilicon tree
...
| Product | Role |
|---------|------|
| `NativeBlaboom` | Main app (bundled as `Blaboom.app`) |
| `NativeBlaboomPolishWorker` | Out-of-process MLX polishing worker |
| `NativeBlaboomCore` | Shared models, stores, services |
...
| Glossary | `~/Library/Application Support/NativeBlaboom/glossary.json` |
| Logs export | `~/Library/Application Support/NativeBlaboom/Logs/` |
...
This is **source-available**, not OSI “open source”: companies may not use Blaboom for commercial purposes without a paid agreement.
