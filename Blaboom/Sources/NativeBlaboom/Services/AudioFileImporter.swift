...
enum AudioFileImporter {
    static func recording(from url: URL) throws -> AudioRecording {
        ...
        do {
            ...
            NativeBlaboomLog.transcription.warning("Audio import is not supported by AVFoundation for \(url.lastPathComponent, privacy: .public). error=\(error.localizedDescription, privacy: .public)")
            throw NSError(
                domain: "NativeBlaboomAudioImport",
                code: 415,
                userInfo: [
