...
actor WhisperKitTranscriptionEngine: TranscriptionEngine {
    ...
    func transcribe(
        _ request: NativeBlaboomCore.TranscriptionRequest
    ) async throws -> NativeBlaboomCore.TranscriptionResult {
        ...
        NativeBlaboomLog.transcription.info(
        ...
        return NativeBlaboomCore.TranscriptionResult(
            text: text,
            diagnostics: NativeBlaboomCore.EngineDiagnostics(
    ...
    private func resolveDecodingOptions(
        for request: NativeBlaboomCore.TranscriptionRequest,
        pipeline: WhisperKit,
        audioPath: String
