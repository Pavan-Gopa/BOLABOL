...
extension Notification.Name {
  ...
  static let showOnboarding = Notification.Name("nativeBlaboomShowOnboarding")
}
  ...
  private var modesStep: some View {
    VStack(alignment: .leading, spacing: 12) {
      ...
      modeCard(
        ...
        tryMode(notification: .nativeBlaboomHotkeyTriggered)
      }
      ...
      modeCard(
        ...
        tryMode(notification: .nativeBlaboomTargetHotkeyTriggered)
      }
      ...
      modeCard(
        ...
        tryMode(
          notification: .nativeBlaboomQuickTranslationHotkeyTriggered
        )
      }
    }
    .padding(.horizontal, 28)
