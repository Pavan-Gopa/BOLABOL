...
public struct BlaboomNote: Identifiable, Codable, Equatable, Sendable {
    public var id: UUID
...
public extension Array where Element == BlaboomNote {
    ...
    static let preview: [BlaboomNote] = [
        BlaboomNote(
            ...
            polishedVariantTwo: "The native rewrite should move text polishing into a first-class in-app engine so performance, model selection, and compute diagnostics are controlled by Blaboom."
        ),
        BlaboomNote(
