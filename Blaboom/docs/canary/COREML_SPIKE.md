...
**Scope:** Blaboom 1.0.3 evaluation of https://huggingface.co/alexwengg/canary-1b-v2-coreml
...
- Options for Blaboom 1.0.3 ASR: WhisperKit (already in use for transcription); if Canary
