#!/usr/bin/env bash
# Submit a signed Blaboom.dmg to Apple notarization and staple the ticket.
set -euo pipefail

ROOT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"
DEFAULT_DMG="$ROOT_DIR/dist/Blaboom.dmg"
DEFAULT_PROFILE="${NOTARY_KEYCHAIN_PROFILE:-Blaboom-Notary}"
...
Environment overrides:
  NOTARY_KEYCHAIN_PROFILE  (default: Blaboom-Notary)
