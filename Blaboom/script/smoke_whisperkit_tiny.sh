...
MODEL_CACHE="${MODEL_CACHE:-/tmp/native-blaboom-whisperkit-smoke-models}"
TOKENIZER_CACHE="${TOKENIZER_CACHE:-/tmp/native-blaboom-whisperkit-smoke-tokenizers}"
REPORT_DIR="${REPORT_DIR:-/tmp/native-blaboom-whisperkit-report}"
