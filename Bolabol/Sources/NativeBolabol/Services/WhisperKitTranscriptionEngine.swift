...
actor WhisperKitTranscriptionEngine: TranscriptionEngine {
    ...
    func transcribe(
        _ request: NativeBolabolCore.TranscriptionRequest
    ) async throws -> NativeBolabolCore.TranscriptionResult {
        ...
        return NativeBolabolCore.TranscriptionResult(
            text: text,
            diagnostics: NativeBolabolCore.EngineDiagnostics(
    ...
    private func resolveDecodingOptions(
        for request: NativeBolabolCore.TranscriptionRequest,
        pipeline: WhisperKit,
        audioPath: String
