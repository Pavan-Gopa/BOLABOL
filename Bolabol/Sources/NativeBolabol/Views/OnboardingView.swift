...
extension Notification.Name {
  ...
  static let showOnboarding = Notification.Name("nativeBolabolShowOnboarding")
}
  ...
  private var modesStep: some View {
    VStack(alignment: .leading, spacing: 12) {
      ...
      modeCard(
        ...
        tryMode(notification: .nativeBolabolHotkeyTriggered)
      }
      ...
      modeCard(
        ...
        tryMode(notification: .nativeBolabolTargetHotkeyTriggered)
      }
      ...
      modeCard(
        ...
        tryMode(
          notification: .nativeBolabolQuickTranslationHotkeyTriggered
        )
      }
    }
    .padding(.horizontal, 28)
