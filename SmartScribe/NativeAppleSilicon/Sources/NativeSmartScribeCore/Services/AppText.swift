...
public enum AppText {
    ...
    private static let translations: [String: [AppTextKey: String]] = [
        "en": [
            ...
            .microphoneAccessDisabled: "Microphone access is disabled for NativeSmartScribe.",
            ...
            .speechPermissionDisabled: "Speech recognition permission is disabled for NativeSmartScribe.",
        ...
        "ru": [
            ...
            .microphoneAccessDisabled: "Для NativeSmartScribe отключён доступ к микрофону.",
            ...
            .speechPermissionDisabled: "Для NativeSmartScribe отключено разрешение на распознавание речи.",
