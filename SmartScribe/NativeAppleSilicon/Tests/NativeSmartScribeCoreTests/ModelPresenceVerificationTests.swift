...
func modelPresenceRequiresCompleteMLXMetadataAndWeights() throws {
    let root = FileManager.default.temporaryDirectory
        .appendingPathComponent("NativeSmartScribePresence-\(UUID().uuidString)", isDirectory: true)
...
func modelPresenceRejectsIncompleteMLXShardSets() throws {
    let root = FileManager.default.temporaryDirectory
        .appendingPathComponent("NativeSmartScribeShards-\(UUID().uuidString)", isDirectory: true)
    defer { try? FileManager.default.removeItem(at: root) }
...
func modelPresenceRequiresWhisperKitCompiledModelAndMetadata() throws {
    let root = FileManager.default.temporaryDirectory
        .appendingPathComponent("NativeSmartScribeWhisperKit-\(UUID().uuidString)", isDirectory: true)
    defer { try? FileManager.default.removeItem(at: root) }
