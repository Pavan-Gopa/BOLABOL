...
MODEL_CACHE="${MODEL_CACHE:-/tmp/native-smartscribe-whisperkit-smoke-models}"
TOKENIZER_CACHE="${TOKENIZER_CACHE:-/tmp/native-smartscribe-whisperkit-smoke-tokenizers}"
REPORT_DIR="${REPORT_DIR:-/tmp/native-smartscribe-whisperkit-report}"
