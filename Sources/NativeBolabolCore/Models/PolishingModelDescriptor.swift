    ...
    static let nativeMLX: PolishingModelCatalog = {
        ...
        models: [
            ...
            PolishingModelDescriptor(
                ...
                repositoryID: "LiquidAI/LFM2.5-2.6B-MLX-4bit",
                backend: .mlxSwiftLLM,
                downloadSize: "~1.6 GB",
                badge: "Experiment",
                description: "Liquid hybrid LFM2.5, official MLX build. Stronger rewrite quality in this experiment; Russian support is unofficial.",
                quality: 4,
                speed: 4
            )
        ]
