...
public struct TranscriptionModelInstallationState: Codable, Equatable, Sendable {
    ...
    public static func notDownloaded() -> TranscriptionModelInstallationState {
        TranscriptionModelInstallationState(status: .notDownloaded)
    }
